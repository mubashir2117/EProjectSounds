    ...
    <div class="container footer-inner">
        <div class="row g-5">
            ...
            <div class="col-lg-4 footer-brand">
                ...
                <p>A premium music & video platform where artists make their mark on the world. Stream cinematic sound, discover new voices, and feel every beat.</p>
            ...
            <div class="col-6 col-md-4 col-lg-2">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="songsone.php">Songs</a></li>
                    <li><a href="videoone.php">Videos</a></li>
            ...
            <div class="col-12 col-lg-2">
                <h4 class="footer-title">Stay on the mark</h4>
                <p style="font-size:13.5px;color:var(--muted);font-weight:300;">New drops, releases & artist news.</p>
                <form class="newsletter-form" id="newsletterForm" action="contact.php" method="POST">
                    <input type="email" name="c_email" placeholder="Your email" aria-label="Email address" required>
                    <button type="submit" name="newsletter" aria-label="Subscribe">
        ...
        <div class="footer-bottom">
            <p>© <?php echo date("Y"); ?> YOUR VOICE ON THE MARK. All rights reserved.</p>
            <p class="footer-heart">Made with ♥ for music lovers</p>
        </div>
    </div>
</footer>

<!-- BACK TO TOP -->
<button class="to-top hoverable" id="toTop" aria-label="Back to top">
